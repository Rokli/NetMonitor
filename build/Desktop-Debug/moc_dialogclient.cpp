...
namespace {
struct qt_meta_tag_ZN12DialogClientE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN12DialogClientE = QtMocHelpers::stringData(
    "DialogClient",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12DialogClientE[] = {
...
Q_CONSTINIT const QMetaObject DialogClient::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12DialogClientE.offsetsAndSizes,
    qt_meta_data_ZN12DialogClientE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12DialogClientE_t,
        // Q_OBJECT / Q_GADGET
...
void *DialogClient::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12DialogClientE.stringdata0))
