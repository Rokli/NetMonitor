...
namespace {
struct qt_meta_tag_ZN12DialogServerE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN12DialogServerE = QtMocHelpers::stringData(
    "DialogServer"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12DialogServerE[] = {
...
Q_CONSTINIT const QMetaObject DialogServer::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12DialogServerE.offsetsAndSizes,
    qt_meta_data_ZN12DialogServerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12DialogServerE_t,
        // Q_OBJECT / Q_GADGET
...
void *DialogServer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12DialogServerE.stringdata0))
